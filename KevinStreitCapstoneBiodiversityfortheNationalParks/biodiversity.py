...
is_conserve = lambda df: 'True' if df != 'No Intervention' else 'False'
species['is_protected'] = species.conservation_status.apply(is_conserve)
print species.head()
...
#print contingencyRM
chi2RM, pvalRM, dofRM, expectedRM = chi2_contingency(contingencyRM)
print pvalRM
...
weeks_at_bryce = sample_size/obs_by_park.observations[obs_by_park.park_name == 'Bryce National Park']
print weeks_at_bryce.iloc[0]
weeks_at_yellow = sample_size/obs_by_park.observations[obs_by_park.park_name == 'Yellowstone National Park']
print weeks_at_yellow.iloc[0]
